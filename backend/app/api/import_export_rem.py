...
TEMPLATES = {
    ...
    "items": {
        ...
        "columns": [
            ...
            ("shelf_life_days", "Shelf-Life (days)", 18, "Number — Optional shelf life in days"),
            ("status", "Status", 12, "Active / Inactive"),
        ],
        "model": Item,
    },
        ...
        for row_idx, row in enumerate(ws.iter_rows(min_row=4, values_only=True), start=4):
            ...
            try:
                ...
                for i, field in enumerate(field_names):
                    ...
                    if field in ('import_lead_time_days', 'production_lead_time_days', 'shelf_life_days', 'year', 'month'):
