...
async def list_sales(
    ...
    item_code: Optional[str] = None, warehouse_code: Optional[List[str]] = Query(None),
    year: Optional[int] = None, month: Optional[List[int]] = Query(None),
    brand: Optional[List[str]] = Query(None), item_group: Optional[List[str]] = Query(None),
    channel: Optional[List[str]] = Query(None), region: Optional[List[str]] = Query(None),
